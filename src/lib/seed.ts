...
export const SEED_IDEAS: Idea[] = [
  { id: 'i1', title: 'AI 穿搭镜：每天不用想穿什么', content: '一个带 AI 摄像头和屏幕的智能穿衣镜，每天早上扫一下你的脸+今天的天气日程，自动推荐搭配方案。还能虚拟试穿新衣服，不买也能看看效果。', highlight: '再也不会有「衣柜满满但没衣服穿」的焦虑了', images: ['https://picsum.photos/id/1/800/400'], author: USERS[0], isAnonymous: false, category: 'life', tags: ['AI', '智能家居', '懒人神器'], likes: 142, comments: 28, favorites: 67, createdAt: '2026-05-30T09:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i2', title: '用脑电波控制PPT翻页', content: '戴一个简易的脑电波头环，专注的时候PPT自动翻下一页，走神的时候暂停并闪烁提醒。适合演讲训练和开会时控制演讲节奏。', highlight: '再也不用偷偷在桌子底下找翻页笔了', images: ['https://picsum.photos/id/96/800/400'], author: USERS[1], isAnonymous: false, category: 'tech', tags: ['脑机接口', '办公工具', 'AI'], likes: 89, comments: 15, favorites: 43, createdAt: '2026-05-29T14:30:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i3', title: '流浪猫狗身份扫码喂食器', content: '在城市的流浪猫狗聚集点放置智能喂食器，每只动物脖子上挂一个防水二维码。扫码后投喂，同时记录投喂时间和健康数据。市民可以认领「赞助」某只动物的伙食费。', highlight: '用科技让流浪动物不再挨饿', images: ['https://picsum.photos/id/237/800/400'], author: USERS[2], isAnonymous: false, category: 'society', tags: ['公益', '宠物', '智能硬件'], likes: 256, comments: 42, favorites: 130, createdAt: '2026-05-28T10:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i4', title: '如果时间是一种货币你会怎么花？', content: '假设每个人每天有24小时的时间币，可以存储、借贷甚至交易。你可以用时间币买别人的时间（让人替你干活），也可以卖自己的时间。但时间币不能继承，人走币清。这会怎样改变社会？', highlight: '最公平也最残酷的经济体系', images: ['https://picsum.photos/id/24/800/400'], author: null, isAnonymous: true, category: 'fantasy', tags: ['社会实验', '哲学', '经济学'], likes: 320, comments: 89, favorites: 178, createdAt: '2026-05-27T16:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i5', title: 'AI自动生成游戏关卡，每天玩不完', content: '基于你之前的游戏风格，AI 实时生成完全新的关卡和敌人。每次进游戏都是独一无二的地图，没有重复感。BOSS 也会学习你的打法，越来越难。', highlight: '一款永远通关不了的游戏', images: [], author: USERS[3], isAnonymous: false, category: 'entertain', tags: ['AI', '游戏设计', '无限内容'], likes: 198, comments: 51, favorites: 95, createdAt: '2026-05-26T20:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i6', title: '共享阳台种菜计划', content: '小区里每家贡献一点阳台空间，连成一片智能菜园。有水肥一体化系统统一管理，住户用 app 认领自己的小区域，种什么邻里投票决定。收获的蔬菜按贡献分配。', highlight: '把阳台连起来，城市也能种菜', images: ['https://picsum.photos/id/13/800/400', 'https://picsum.photos/id/15/800/400'], author: USERS[4], isAnonymous: false, category: 'life', tags: ['社区', '环保', '智能家居'], likes: 167, comments: 34, favorites: 82, createdAt: '2026-05-25T11:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i7', title: '用 AR 给现实世界贴「注释」', content: '戴 AR 眼镜走在街上，可以看到其他用户贴在真实物体上的虚拟注释。比如路过一棵树，看到「这棵银杏有120年了」；经过一家店，看到「这家的咖啡偏酸」。像给世界加了一层维基百科。', highlight: '现实世界的信息密度提升100倍', images: ['https://picsum.photos/id/20/800/400'], author: USERS[1], isAnonymous: false, category: 'tech', tags: ['AR', '社交', '信息'], likes: 234, comments: 63, favorites: 112, createdAt: '2026-05-24T08:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i8', title: '把微信步数换成电费折扣', content: '跟电力公司合作，每天走够8000步，当天的家庭用电打9折。走越多折扣越大。运动数据加密传输，只告诉电力公司「步数是否达标」而不暴露具体路径。', highlight: '迈开腿就是在省钱', images: [], author: null, isAnonymous: true, category: 'work', tags: ['健康', '激励', '数据隐私'], likes: 145, comments: 27, favorites: 59, createdAt: '2026-05-23T15:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
  { id: 'i9', title: '宠物情绪翻译项圈（悬赏5000元）', content: '一个智能项圈，通过分析狗叫的频率、音调、以及心率变化，用AI判断狗狗当前的情绪状态（开心、焦虑、生气、饿了）。翻译结果推送到手机，还会给出建议动作。', highlight: '终于知道你家狗子在想什么了', images: ['https://picsum.photos/id/40/800/400'], author: USERS[0], isAnonymous: false, category: 'life', tags: ['宠物', 'AI', '硬件'], likes: 312, comments: 76, favorites: 145, createdAt: '2026-05-22T12:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: true },
  { id: 'i10', title: '如果地球突然变成甜甜圈形状', content: '地理课要重写了。赤道变成甜甜圈的内圈，两极在甜甜圈的顶部和底部。引力场会怎么分布？海洋会流到哪里？文明会沿着内圈发展还是外圈？也许甜甜圈中心的空间站是最佳观景位。', highlight: '地理老师看了会沉默', images: [], author: USERS[4], isAnonymous: false, category: 'fantasy', tags: ['科学幻想', '物理', '荒诞'], likes: 278, comments: 93, favorites: 156, createdAt: '2026-05-21T19:00:00Z', likedByMe: false, favoritedByMe: false, isBounty: false },
]
