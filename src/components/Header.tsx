      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center gap-6">
        ...
        <Link href="/discover" className="flex items-center gap-2.5 shrink-0 no-underline group">
          ...
          <span className="text-lg font-bold tracking-tight">
            <span className="bg-gradient-to-r from-purple-600 to-purple-500 bg-clip-text text-transparent">嘿洞</span>
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          {/* 通知 */}
          <Link href="/profile?tab=comments" className="hidden md:flex w-9 h-9 items-center justify-center rounded-xl text-gray-400 hover:bg-gray-100/80 hover:text-gray-600 transition-all relative no-underline">
